      ...
      <div className="bg-white shadow-lg rounded-xl w-full max-w-2xl p-8">
        ...
        <form className="flex flex-col gap-4">
          ...
          <div className="flex flex-col">
            ...
            <input type="text" placeholder="Course Title" className="input input-bordered w-full" />
          </div>

          {/* Description */}
          <div className="flex flex-col">
            <label className="font-semibold text-gray-700 mb-1">Description</label>
            <textarea placeholder="About course" className="textarea textarea-bordered w-full h-24 resize-none"></textarea>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <input type="text" placeholder="Coupon Code" className="input input-bordered w-full" />
          </div>

          {/* Discounted Price */}
          <div className="flex flex-col">
            <label className="font-semibold text-gray-700 mb-1">Discounted Price</label>
            <input type="number" placeholder="Discounted Price" className="input input-bordered w-full" />
          </div>
